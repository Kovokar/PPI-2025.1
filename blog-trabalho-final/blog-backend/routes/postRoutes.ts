...
import { CommentRepository } from "../repositories/CommentRepository"; // Necessário para rotas de comentários aninhadas
import { Postagem } from "../models/Postagem";
import { Comentario } from "../models/Comentario"; // Necessário para rotas de comentários aninhadas
import sql from "../db";

const router = express.Router();
const postRepository = new PostRepository(sql);
const commentRepository = new CommentRepository(sql); // Instanciar aqui para as rotas aninhadas

// Definir os caminhos base para as rotas de postagem
...
const COMENTARIOS_PATH = `${ID_PATH}/comentarios`; // Rotas de comentários aninhadas
